...
public class RegdollControllerInfector : MonoBehaviour
{
    ...
    public void ActiveRagdoll()
    {
        ...
        Transform damageCarrierInfector1 = transform.Find("bone_1"); //자식 오브젝트 위치 찾기
        Transform damageCarrierInfector2 = transform.Find("bone_1/bone_f1");
        Transform damageCarrierInfector3 = transform.Find("bone_1/bone_11");
        damageCarrierInfector1.GetComponent<CircleCollider2D>().enabled = false; //사격에서 제외하도록 콜라이더 박스 해제
        damageCarrierInfector2.GetComponent<CapsuleCollider2D>().enabled = false;
    ...
    public void DisableRagdoll()
    {
        ...
        Transform damageCarrierInfector2 = transform.Find("bone_1/bone_f1");
        Transform damageCarrierInfector3 = transform.Find("bone_1/bone_11");
        damageCarrierInfector1.GetComponent<CircleCollider2D>().enabled = true;
        damageCarrierInfector2.GetComponent<CapsuleCollider2D>().enabled = true;
        damageCarrierInfector3.GetComponent<BoxCollider2D>().enabled = true;
        damageCarrierInfector1.gameObject.layer = 16;
        damageCarrierInfector2.gameObject.layer = 16;
        damageCarrierInfector3.gameObject.layer = 16;
