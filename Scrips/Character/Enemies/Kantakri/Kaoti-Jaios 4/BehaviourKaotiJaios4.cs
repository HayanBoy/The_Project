...
public class BehaviourKaotiJaios4 : MonoBehaviour
{
    ObjectManager objectManager;
    KaotiJaios4Spear kaotiJaios4Spear;
    Rigidbody2D rb2d;
    Animator animator;
            ...
            while (true)
            {
                ...
                if (GunFirstDown == false)
                {
                    if (GunHitPoint2 <= GunHitPointTotal / 2)
                    {
                        ...
                        if (GunDown == 0 && kaotiJaios4Spear.hitPoints > 0)
                        {
                            Gun1Down = true;
                            GunFirst1Down = true;
                            kaotiJaios4Spear.TearOn = true;
                            ...
                            gameObject.transform.GetComponent<KaotiJaios4Spear>().Gun1Down = true;
                            gameObject.transform.GetComponent<KaotiJaios4Spear>().PartDeathGun1();
                        }
                        else if (GunDown == 1 && kaotiJaios4Spear.hitPoints > 0)
                        {
                            Gun2Down = true;
                            GunFirst2Down = true;
                            kaotiJaios4Spear.TearOn = true;
                            ...
                            gameObject.transform.GetComponent<KaotiJaios4Spear>().Gun2Down = true;
                            gameObject.transform.GetComponent<KaotiJaios4Spear>().PartDeathGun2();
                        }
                        GunDown = 5;
                    }
                }
                ...
                {
                    if (GunFirst1Down == true && kaotiJaios4Spear.hitPoints > 0)
                    {
                        GunFirst1Down = false;
                        Gun2Down = true;
                        kaotiJaios4Spear.TearOn = true;
                    ...
                    else if (GunFirst2Down == true && kaotiJaios4Spear.hitPoints > 0)
                    {
                        GunFirst2Down = false;
                        Gun1Down = true;
                        kaotiJaios4Spear.TearOn = true;
    ...
    public IEnumerator WheelDamage(int damage, float interval)
    {
        if (WheelDown == false)
        {
            while (true)
            {
                ...
                if (WheelHitPoint2 <= float.Epsilon && kaotiJaios4Spear.hitPoints > 0)
                {
                    ...
                    gameObject.transform.GetComponent<KaotiJaios4Spear>().WheelDown = true;
                    gameObject.transform.GetComponent<KaotiJaios4Spear>().PartDeathWheel();
                    WheelDown = true;
                    currnetSpeed = 0;
    ...
    void Start()
    {
        ...
        kaotiJaios4Spear = FindObjectOfType<KaotiJaios4Spear>();
    ...
    private void OnEnable()
    {
        ...
        WheelHitPoint = GetComponent<KaotiJaios4Spear>().startingHitPoints / 4;
        GunHitPoint = GetComponent<KaotiJaios4Spear>().startingHitPoints / 4;
