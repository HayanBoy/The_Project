...
public class KaotiJaios4 : Character
{
    BehaviourKaotiJaios4_ BehaviourKaotiJaios4;
    ...
    public void RandomSound()
    {
        ...
        if (RicochetSoundRandom == 0)
            SoundManager.instance.SFXPlay4("Sound", RicochetSound1);
        else if (RicochetSoundRandom == 1)
            SoundManager.instance.SFXPlay4("Sound", RicochetSound2);
        else if (RicochetSoundRandom == 2)
            SoundManager.instance.SFXPlay4("Sound", RicochetSound3);
        else if (RicochetSoundRandom == 3)
            SoundManager.instance.SFXPlay4("Sound", RicochetSound4);
        else if (RicochetSoundRandom == 4)
            SoundManager.instance.SFXPlay4("Sound", RicochetSound5);
    }
    ...
    public void Start()
    {
        ...
        BehaviourKaotiJaios4 = FindObjectOfType<BehaviourKaotiJaios4_>();
    ...
    private void OnEnable()
    {
        if (BattleSave.Save1.MissionLevel == 1)
        {
            ...
            else if (Number == 2) //ī��Ƽ-���̿��� 4(Kantarr-Jaeratroy Boss fleet)
            {
                hitPoints = 350;
                startingHitPoints = 350;
                maxHitPoints = 425;
                armor = 1;
                startingArmor = 1;
                KantakriRicochet = 15;
            ...
            else if (Number == 3) //ī��Ƽ-���̿��� 4(Kantarr-Jaeratroy Boss fleet Armor)
            {
                hitPoints = 550;
                startingHitPoints = 550;
                maxHitPoints = 650;
                armor = 1.1f;
                startingArmor = 1.1f;
                KantakriRicochet = 10;
    ...
    void Update()
    {
        ...
        if (VoiceRandom == 0)
        {
            ...
            else if (VoicePrint == 1)
            {
                ...
                {
                    VoiceTime += Time.deltaTime;
                    SoundManager.instance.SFXPlay30("Sound", Voice2);
                }
            }
            else if (VoicePrint == 2)
            {
                ...
                {
                    VoiceTime += Time.deltaTime;
                    SoundManager.instance.SFXPlay30("Sound", Voice3);
                }
            }
            else if (VoicePrint == 3)
            {
                ...
                {
                    VoiceTime += Time.deltaTime;
                    SoundManager.instance.SFXPlay30("Sound", Voice4);
                }
            }
            else if (VoicePrint == 4)
            {
                ...
                {
                    VoiceTime += Time.deltaTime;
                    SoundManager.instance.SFXPlay30("Sound", Voice5);
                }
            }
        }
        else
     ...
     if(DeathCount == false)
        {
            while (true)
            {
                int RicochetRandom = Random.Range(0, KantakriRicochet);
                if (RicochetRandom != 0 || NoRicochet == true)
                {
    ...
    */
    ...
    void Death()
    {
        ...
        if (Gun2Down == false && BehaviourKaotiJaios4.Gun2Down == false)
        {
            GunBack = SingletonObject.instance.Loader(DeathGunBackName);
            GunBack.transform.position = gunBackPos.position;
            GunBack.transform.rotation = gunBackPos.rotation;
        ...
        if (Gun1Down == false && BehaviourKaotiJaios4.Gun1Down == false)
        {
            GunFront = SingletonObject.instance.Loader(DeathGunFrontName);
            GunFront.transform.position = gunFrontPos.position;
            GunFront.transform.rotation = gunFrontPos.rotation;
        ...
        if (WheelDown == false && BehaviourKaotiJaios4.WheelDown == false)
        {
            TireBack = SingletonObject.instance.Loader("tireBack");
            TireBack.transform.position = tireBackPos.position;
            TireBack.transform.rotation = tireBackPos.rotation;
