...
public class KaotiJaios4Spear : Character
{
    Animator animator;
    BehaviourKaotiJaios4 BehaviourKaotiJaios4;
    ...
    public void Start()
    {
        ...
        BehaviourKaotiJaios4 = FindObjectOfType<BehaviourKaotiJaios4>();
    ...
    public void PartDeathGun1()
    {
        if (Gun1Down == true)
        {
            GunFront = SingletonObject.instance.Loader("gunFront");
    ...
    public void PartDeathGun2()
    {
        if (Gun2Down == true)
        {
            GunBack = SingletonObject.instance.Loader("gunBack");
