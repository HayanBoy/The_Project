...
public class DropingKaotiJaios4 : MonoBehaviour
{
    float dropSpeed = 20f;
    float dropTime;
    bool falling = false;
    ...
    public void SetDroping(bool droping)
    {
        if(droping == true)
        {
            gameObject.GetComponent<BehaviourKaotiJaios4_>().enabled = false; //�ൿ ��ũ��Ʈ ����
    ...
    IEnumerator TheFall()
    {
        ...
        SlowDown = false;
        //���� Ȱ��ȭ �� �ൿ ����
        gameObject.GetComponent<BehaviourKaotiJaios4_>().enabled = true;
