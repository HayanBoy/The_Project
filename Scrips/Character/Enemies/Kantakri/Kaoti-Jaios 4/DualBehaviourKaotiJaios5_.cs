...
public class DualBehaviourKaotiJaios5_ : MonoBehaviour
{
    ObjectManager objectManager;
    KaotiJaios4Dual kaotiJaios4;
    Rigidbody2D rb2d;
    Animator animator;
    ...
    public void RandomSound()
    {
        ...
        if (RicochetSoundRandom == 0)
            ...
            SoundManager.instance.SFXPlay2("Sound", FireSound2);
        else if (RicochetSoundRandom == 2)
            SoundManager.instance.SFXPlay2("Sound", FireSound3);
        else if (RicochetSoundRandom == 3)
            SoundManager.instance.SFXPlay2("Sound", FireSound4);
        else if (RicochetSoundRandom == 4)
            SoundManager.instance.SFXPlay2("Sound", FireSound5);
    }
            ...
            while (true)
            {
                ...
                if (GunFirstDown == false)
                {
                    if (GunHitPoint2 <= GunHitPointTotal / 2)
                    {
                        ...
                        if (GunDown == 0 && kaotiJaios4.hitPoints > 0)
                        {
                            ...
                            animator.SetBool("Kaoti-Jaios 4 No Gun1 dual", true);
                            gameObject.transform.GetComponent<KaotiJaios4Dual>().Gun1Down = true;
                            gameObject.transform.GetComponent<KaotiJaios4Dual>().PartDeathGun1();
                        }
                        else if (GunDown == 1 && kaotiJaios4.hitPoints > 0)
                        {
                            ...
                            GunExplosion.transform.position = GunExplosionPos.position;
                            GunExplosion.transform.rotation = GunExplosionPos.rotation;
                            animator.SetBool("Kaoti-Jaios 4 No Gun2 dual", true);
                            gameObject.transform.GetComponent<KaotiJaios4Dual>().Gun2Down = true;
                            gameObject.transform.GetComponent<KaotiJaios4Dual>().PartDeathGun2();
                        }
                    }
                }
                ...
                if (GunHitPoint2 <= float.Epsilon)
                {
                    if (GunFirst1Down == true && kaotiJaios4.hitPoints > 0)
                    {
                        ...
                        GunExplosion.transform.position = GunExplosionPos.position;
                        GunExplosion.transform.rotation = GunExplosionPos.rotation;
                        animator.SetBool("Kaoti-Jaios 4 No Gun All dual", true);
                        gameObject.transform.GetComponent<KaotiJaios4Dual>().Gun2Down = true;
                        gameObject.transform.GetComponent<KaotiJaios4Dual>().PartDeathGun2();
                    }
        ...
        if (WheelDown == false)
        {
            while (true)
            {
                ...
                if (WheelHitPoint2 <= float.Epsilon && kaotiJaios4.hitPoints > 0)
                {
                    ...
                    gameObject.transform.GetComponent<KaotiJaios4Dual>().WheelDown = true;
                    gameObject.transform.GetComponent<KaotiJaios4Dual>().PartDeathWheel();
                    WheelDown = true;
                    currnetSpeed = 0;
    ...
    void Start()
    {
        ...
        kaotiJaios4 = FindObjectOfType<KaotiJaios4Dual>();
    ...
    private void OnEnable()
    {
        ...
        {
            if (GetComponent<KaotiJaios4Dual>().Number == 1) //ī��Ƽ-���̿��� 4(���)
            {
                Damage = 30;
                fireDelay = 0.4f;
                enemyShoot = 4;
            ...
            else if (GetComponent<KaotiJaios4Dual>().Number == 2) //ī��Ƽ-���̿��� 4(Armor ���)
            {
                Damage = 25;
                fireDelay = 0.6f;
                enemyShoot = 4;
        ...
        {
            if (GetComponent<KaotiJaios4Dual>().Number == 1)
            {
                Damage = 42;
                fireDelay = 0.3f;
                enemyShoot = 3;
            ...
            else if (GetComponent<KaotiJaios4Dual>().Number == 2)
            {
                Damage = 35;
                fireDelay = 0.5f;
                enemyShoot = 3;
        ...
        WheelHitPoint = GetComponent<KaotiJaios4Dual>().startingHitPoints / 4;
        GunHitPoint = GetComponent<KaotiJaios4Dual>().startingHitPoints / 4;
    ...
    private void OnDisable()
    {
        ...
        if (animator.GetBool("Kaoti-Jaios 4 Wheel Down ImDown!") == true)
            animator.SetBool("Kaoti-Jaios 4 Wheel Down ImDown!", false);
        if (animator.GetBool("Kaoti-Jaios 4 No Gun1 dual") == true)
            animator.SetBool("Kaoti-Jaios 4 No Gun1 dual", false);
        if (animator.GetBool("Kaoti-Jaios 4 No Gun2 dual") == true)
            animator.SetBool("Kaoti-Jaios 4 No Gun2 dual", false);
        if (animator.GetBool("Kaoti-Jaios 4 No Gun All dual") == true)
            animator.SetBool("Kaoti-Jaios 4 No Gun All dual", false);
    ...
    {
        FireEffect2(); //��� ȿ��
        GameObject FrontAmmo = SingletonObject.instance.Loader_Dualammo();
        ...
        GameObject FrontAmmo2 = SingletonObject.instance.Loader_Dualammo();
    ...
    {
        FireEffect(); //��� ȿ��
        GameObject BackAmmo = SingletonObject.instance.Loader_Dualammo();
        ...
        GameObject BackAmmo2 = SingletonObject.instance.Loader_Dualammo();
