...
public class HealthTaikaLaiThrotro1 : Character
{
    Animator animator;
    BehaviorTaikaLaiThrotro1_ BehaviorTaikaLaiThrotro1;
    ...
    public void RandomSound()
    {
        ...
        if (RicochetSoundRandom == 0)
            ...
            SoundManager.instance.SFXPlay6("Sound", RicochetSound5);
    }

    public void Start()
    {
        animator = GetComponent<Animator>();
        BehaviorTaikaLaiThrotro1 = FindObjectOfType<BehaviorTaikaLaiThrotro1_>();
    ...
    public void PartDeathGun()
    {
        if (GunDown == true)
        {
            GameObject RailGun = SingletonObject.instance.Loader("Taika_railGun");
            RailGun.transform.position = railGunPos.position;
            RailGun.transform.rotation = railGunPos.rotation;
            DeathTaikaLaiThrotro1 RailGunpos = RailGun.GetComponent<DeathTaikaLaiThrotro1>();
            RailGunpos.Pos = RailGun.transform.position.y;
        }
    }
    public void PartDeathEngine1()
    {
        if (Engine1Down == true)
        {
            ...
            DeathTaikaLaiThrotro1 FrontEnginepos = FrontEngine.GetComponent<DeathTaikaLaiThrotro1>();
            FrontEnginepos.Pos = FrontEngine.transform.position.y;
        }
    }
    public void PartDeathEngine2()
    {
        if (Engine2Down == true)
        {
            ...
            DeathTaikaLaiThrotro1 BackEnginepos = BackEngine.GetComponent<DeathTaikaLaiThrotro1>();
            BackEnginepos.Pos = BackEngine.transform.position.y;
        }
    }
    ...
    void Death()
    {
        GameObject Body = SingletonObject.instance.Loader("Taika_body");
        Body.transform.position = bodyPos.position;
        Body.transform.rotation = bodyPos.rotation;
        DeathTaikaLaiThrotro1 Bodypos = Body.GetComponent<DeathTaikaLaiThrotro1>();
        Bodypos.Pos = Body.transform.position.y;

        if (Engine1Down == false && BehaviorTaikaLaiThrotro1.Engine1Down == false)
        {
            GameObject FrontEngine = SingletonObject.instance.Loader("Taika_frontEngine");
            FrontEngine.transform.position = frontEnginePos.position;
            FrontEngine.transform.rotation = frontEnginePos.rotation;
        ...
        if (Engine2Down == false && BehaviorTaikaLaiThrotro1.Engine2Down == false)
        {
            GameObject BackEngine = SingletonObject.instance.Loader("Taika_backEngine");
            BackEngine.transform.position = backEnginePos.position;
            BackEngine.transform.rotation = backEnginePos.rotation;
        ...
        if (GunDown == false && BehaviorTaikaLaiThrotro1.GunDown == false)
        {
            GameObject RailGun = SingletonObject.instance.Loader("Taika_railGun");
            RailGun.transform.position = railGunPos.position;
            RailGun.transform.rotation = railGunPos.rotation;
