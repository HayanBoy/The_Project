...
public class NomalBullet : MonoBehaviour
{
    ...
    void Active()
    {
        HTACAmmo = vehicleObjectsManager.VehicleLoader("HTACExplosion");
        HTACAmmo.transform.position = HTACAmmoPos.position;
        HTACAmmo.transform.rotation = HTACAmmoPos.rotation;
        VM5Damage VM5Damage = HTACAmmo.gameObject.transform.GetComponent<VM5Damage>();
